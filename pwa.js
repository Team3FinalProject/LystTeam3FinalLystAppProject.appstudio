...
const cacheName = 'LystTeam3FinalProjectSedlacek-2021-04-20 22:47:51.257891'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LystTeam3FinalProjectSedlacek'.length) === 'LystTeam3FinalProjectSedlacek') {
